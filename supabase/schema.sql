...
('Адмін', '["Планування замірів", "Заміри (AppSheet)", "Конструктив", "Виробництво (MES)", "Планування доставок", "Доставка", "Планування монтажів", "Монтажі (AppSheet)", "Моніторинг замовлень", "Графіки роботи", "Розрахунок ЗП", "Співробітники", "Налаштування ролей", "ШІ Аналітика"]'::jsonb);
